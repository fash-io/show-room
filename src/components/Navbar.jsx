          ...
          <div className=' flex gap-4 lg:gap-15 items-center'>
            ...
            >
              <input
                ...
                className={`outline-none border-none w-0 group-focus-within:w-[180px] sm:group-focus-within:w-[250px] duration-300 ease-in-out transform rounded-xl bg-transparent focus:bg-white/80 px-2 py-[6px] focus:ring-2  text-black placeholder-transparent group-focus-within:placeholder-gray-500`}
                placeholder='Search...'
                ref={IconRef}
                style={{ fontSize: '16px' }}
              />
